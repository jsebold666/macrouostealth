...
begin
  ...
  WaitGump('1');
  Wait(WaitTime*4);
  if BulkBook=0 then AddToSystemJournal('Contagem de Bud = ' + IntToStr(CountEx(BodType,BodColor,backpack)));
...
begin
  ...
  myProfiles:=['mimers', 'mimerss', 'mimersss', 'mimersss', 'mimerssssb', 'mimerssss', 'mimerssssd', 'mimerssssw', 'mimersssswf', 'mimersssswfgg', 'jezzy666tt', 'mestre', 'mimersssswfggfff', 'mimersssswfggfffb', 'mimersssswfggfffbçç', 'novo', 'mimersssswfggfffbdsd', 'tailorbod',  'tailorbod2', 'tailorbod3', 'tailorbod4' , 'tailorbod6', 'tailorbod8', 'tailorbod9', 'tailorbod10'] ; 

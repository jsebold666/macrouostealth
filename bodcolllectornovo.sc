...
begin
  ...
  if BulkBook<>0 then begin
    while (FindTypeEx(BodType,BodColor,backpack,false)>1) do begin 
      AddToSystemJournal('movendo para a bag');
...
begin
  ...
  myProfiles:=['mimers', 'mimerss', 'mimersss', 'mimersss', 'mimerssssb', 'mimerssss', 'mimerssssd', 'mimerssssw', 'mimersssswf', 'mimersssswfgg', 'jezzy666tt', 'mestre', 'mimersssswfggfff', 'mimersssswfggfffb', 'mimersssswfggfffbçç'] ; 
